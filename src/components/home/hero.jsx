...
const Hero = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col items-center h-full md:justify-center absolute w-full bg-black bg-opacity-50 ">
            ...
            {["Travels", "Ticketing", "Holidays", "Visa"].map((item, index) => {
              return (
                <button
                  ...
                  }text-base sm:text-lg md:text-xl lg:text-2xl py-2 px-4 rounded focus:outline-none  `}
                  onClick={() => {
